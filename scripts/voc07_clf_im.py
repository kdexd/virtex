...
if __name__ == "__main__":
    ...
    if _A.weight_init == "checkpoint":
        # Set up a serialization directory, this is usually the directory of
        # pretraining job, containing all checkpoints.
        ...
        logger.info(
            f"Tensorboard logging unavailable for weight_init={_A.weight_init}"
        )
